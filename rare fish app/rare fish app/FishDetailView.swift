...
struct FishDetailView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        VStack(spacing: 12) {
                            StatRowDetail(label: "Current Size", value: "28.5 cm")
                            StatRowDetail(label: "Max Size", value: "32.0 cm")
                            StatRowDetail(label: "Age", value: "4.2 years")
                            StatRowDetail(label: "Vitality", value: "95%")
                            StatRowDetail(label: "Activity Level", value: "High")
                        }
                        .padding()
        ...
        .alert("Offer Submitted!", isPresented: $showOfferAlert) {
            Button("OK", role: .cancel) { }
        } message: {
            Text("Your offer has been submitted to the seller. You'll be notified of any response.")
        }
    }
}
